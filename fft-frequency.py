...
PATH = 'C:/Drivers/Documentos/Worksearch/portfoio/Project_ToneDetector/'
...
AUDIO_FILE = os.path.join(PATH,'recorded_audio.wav')


#fs, data = wavfile.read(os.path.join(PATH,AUDIO_FILE)) # load the data
fs, data = wavfile.read("recorded_audio.wav") # load the data
print(len(data))
print(data)
